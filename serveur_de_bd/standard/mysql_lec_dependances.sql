drop procedure lec_dependances;
delimiter //
create PROCEDURE lec_dependances(p_sens varchar(1),p_nom_tab varchar(50),p_tab_id varchar(500),p_max_lignes int,p_profondeur int)
begin
	declare	v_fini int;
